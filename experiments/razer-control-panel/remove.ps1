...
printf '%s' "`$password" | sudo -S rm -f /usr/local/sbin/razer-control-panel /usr/local/sbin/razer-kms-present /usr/local/sbin/razer-camera-preview /usr/local/sbin/razer-camera-launch /usr/local/sbin/razer-haptic-ff /usr/local/sbin/razer-haptic-test /usr/local/sbin/razer-audio-test /usr/local/sbin/razer-shutdown-console /etc/systemd/system/razer-control-panel.service /run/razer-control-panel.frame /run/razer-camera-preview.log
