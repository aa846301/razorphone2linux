...
static int sw49410_panel_probe(struct mipi_dsi_device *dsi)
{
	...
	drm_panel_init(&ctx->panel, dev, &sw49410_panel_funcs,
...
static struct mipi_dsi_driver sw49410_panel_driver = {
	.driver = {
		.name = "panel-lg-sw49410-lh609qh1",
...
MODULE_DESCRIPTION("DRM driver for LG LH609QH1 DSI Panel with SW49410 controller");
